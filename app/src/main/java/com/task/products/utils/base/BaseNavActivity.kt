package com.task.products.utils.base
...
import com.task.products.utils.EXTRA
import com.task.products.utils.base.interfaces.IBase
import com.task.products.utils.extensions.addExtras
import com.task.products.utils.extensions.plus

/**
 * A base BaseNavViewModel Activity with built-in support for Android X Navigation Concept and ViewModel.
 */
abstract class BaseNavActivity<VB : ViewBinding, VS : IBase.State, VM : IBase.ViewModel<VS>> :
